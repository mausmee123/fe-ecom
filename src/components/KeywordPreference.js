...
const schema = yup.object().shape({
    NewKeyword: yup.string().required(),
    AllKeyword: yup.string().required(),
    ...
    return (
        <ThemeProvider theme={theme}>
            <form onSubmit={handleSubmit(e => onSubmitHandler(e))} style={{width: '100%'}}>
                    <Grid container item className={classes.keyword} item xs={12}>
                        <Grid className={classes.productCategoriesTitle} xs={12}>
                        ...
                        <Grid item lg={6} sm={6} xs={12} className={classes.inputFieldWrapper}>
                            ...
                            <TextField
                                ...
                                {...register("NewKeyword")}
                            />
                            <div className="invalid-feedback">{errors.NewKeyword?.message}</div>
                            <Button
                                variant="contained"
                                color="primary"
                        ...
                        <Grid item lg={6} sm={6} xs={12} className={classes.inputFieldWrapper}>
                            ...
                            <div className="invalid-feedback">{errors.AllKeyword?.message}</div>
...
export default KeywordPreference;
